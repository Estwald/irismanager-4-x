...
SOURCES		+=  source/payload446 source/payload450 source/payload450dex source/payload453
DATA		:=	datas
SHADERS		:=	shaders
...
INCLUDES	+=  include/payload446 include/payload450 include/payload450dex include/payload453
